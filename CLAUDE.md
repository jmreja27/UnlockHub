...
| `lib/formatTimeAgo` (`formatNumber`, `formatDayMonth`, `formatTimeAgo`, `formatBirthDate`) | Formateo de números y fechas sin Intl — usar siempre estas utilidades propias |
