...
> - A53 bcrypt 5→6, tar chain eliminada (CVE-2026-23745 + 1 anterior): -2 HIGH ✅
> - A54 multer 2.1.1→2.2.0 (GHSA-72gw + GHSA-3p4h): -2 HIGH ✅
> - A55 ws 8.20.1→8.21.0 vía engine.io+adapters (GHSA-96hv-2xvq-fx4p): -1 HIGH ✅
> - A56 ws GHSA-58qx-3vcg-4xpx: FP del scanner (ya era 0 en el audit real, A1 lo resolvió en S1) ✅
