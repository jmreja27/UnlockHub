...
| PL22 | ⚙️ Distribución — listing y canales de anuncio — bloque lanzamiento | Listing Play Store afinado con capturas que vendan lo social/stats (no el tracking — eso ya lo hacen Exophase/TrueAchievements). Textos y capturas para anuncio en subreddits r/Trophies, r/RetroAchievements, r/Steam (revisar reglas de autopromo de cada uno) y Discords de cazadores de logros, listos ANTES del día de lanzamiento para poder anunciar sin fricciones el día D. |
